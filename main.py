...
m = Automata(label="M", alphabet=['a', 'b', 'c'])
...
m.create_transaction(departure_label="q1", arrival_label="q1", symbol="a")
...
print(m.recognize(string="abbccabbbaccccccaaaa", verbose=True))
